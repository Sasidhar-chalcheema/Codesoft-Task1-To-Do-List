...
def mark_task_complete():
  ...
  while True:
    try:
      task_number = int(input("Enter the number of the task to mark complete (or 0 to go back): "))
      if task_number == 0:
        return
...
def delete_task():
  ...
  while True:
    try:
      task_number = int(input("Enter the number of the task to delete (or 0 to go back): "))
      if task_number == 0:
        return
      if 1 <= task_number <= len(tasks):
